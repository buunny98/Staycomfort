...
<body>
    ...
    */
    ...
    <div class="marginz justify cus">

        <h2 class="head center">

            Cutsomize your member Page <?php echo $_SESSION['username']; ?>
        </h2>
        <hr>
        <h3> You Can Add Hotels to Your Member Page and Customize it to Your Needs </h3>
        <br>
        <br>
        <form action="mailCustom.php" method="POST" enctype="multipart/form-data">
            ...
            Country: <input type="text" name="hcountry"><br> <br>
            Additional Comments: <textarea name="comm"> </textarea> <br> <br>
